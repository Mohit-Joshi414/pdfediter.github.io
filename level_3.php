...
<div class="container" style="border: solid;text-decoration-color: white; 
	background-color: gray ;border-width: 1px;" >
		...
		<h1 style="text-align: center;">Level-4 Uploaded Files</h1>
	</div>
	<br>
				...
				$i=1;
				 			while($result = mysqli_fetch_array($querydisplay)){
				 				...
				 				<tr>
        							...
        							if(!$('#iframe').length) {
                					$('#<?php echo $id; ?>').html('<iframe id="iframe" src="<?php echo $result['uploaded_by_level_4']; ?>" width="700" height="450"></iframe>');
									...
									<div id="<?php echo $id; ?>"></div></td>
				 					...
				 					//echo $id;
				 					?>
				 					<td><form method="post" action= "level_3_support.php" enctype="multipart/form-data">
				 					 <input type="submit" name="<?php echo $id; ?>"  value="FORWARD" />
				 					 <input type="submit" formaction="reject3.php" name="<?php echo $id; ?>" value= "REJECT">
				 					</form></td>
